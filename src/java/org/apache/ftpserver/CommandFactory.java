...
class CommandFactory implements ICommandFactory {
    ...
    public void configure(Configuration conf) throws FtpException {
        ...
        while(cmds.hasNext()) {
            ...
            try {
                ...
                ICommand cmd = (ICommand)clazz.newInstance();
                commandMap.put(cmdName, cmd);
            }
            catch(Exception ex) {
                log.error("CommandFactory.configure()", ex);
                throw new FtpException("CommandFactory.configure()", ex);
            }
        }
    }
    ...
    public ICommand getCommand(String cmdName) {
        ...
        return (ICommand)commandMap.get(cmdName);
    }
